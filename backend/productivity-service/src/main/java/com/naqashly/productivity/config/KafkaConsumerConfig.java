...
/**
 * <h1>Production-Grade Kafka Consumer Configuration for Productivity Service</h1>
 * 
 * <p><b>WHAT:</b> Configures Spring Kafka {@link ConcurrentKafkaListenerContainerFactory} with JSON deserialization for {@code productivity-consumer-group}.</p>
 * 
...
public class KafkaConsumerConfig {
    ...
    public static final String PRODUCTIVITY_CONSUMER_GROUP = "productivity-consumer-group";
    ...
    public ConsumerFactory<String, BotCommandEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, PRODUCTIVITY_CONSUMER_GROUP);
