package com.naqashly.auth.service;
 ...
 * <h1>EmailService</h1>
 * 
 * <p><b>WHAT:</b> Component handles sending HTML verification emails to newly registered users.</p>
 * <p><b>WHY:</b> Secures user platform onboarding and prevents bot registry.</p>
 * 
...
public class EmailService {
    ...
    /**
     * Sends the custom HTML confirmation email to the user.
     * 
    ...
    public void sendVerificationEmail(String recipientEmail, String userName, String token) {
        try {
            ...
            throw new IllegalStateException("Failed to send verification email to " + recipientEmail, e);
        }
    }
}
