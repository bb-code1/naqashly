  ...
  return (
    <div ref={menuRef} style={{ position: 'relative' }}>
      ...
      >
        ...
        <span className="profile-username" style={{ fontSize: '0.82rem', fontWeight: '800', color: 'var(--text-heading)' }}>
          {username}
        </span>
        <span className="profile-dropdown-arrow" style={{ fontSize: '0.72rem', color: 'var(--text-muted)', transform: isOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s ease' }}>
          ▼
        </span>
      </motion.button>
